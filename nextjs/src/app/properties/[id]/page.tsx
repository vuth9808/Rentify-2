      ...
      try {
        ...
        if (foundBuilding) {
          ...
          setBuilding({
            ...
            serviceFee: foundBuilding.serviceFee?.toString(),
            brokerageFee: foundBuilding.brokerageFee?.toString(),
            managerName: foundBuilding.managerName,
            managerPhone: foundBuilding.managerPhone,
            address: foundBuilding.address
          });
          
          // Ghi lại hoạt động xem bất động sản
          try {
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex justify-center items-center h-64">
          <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-900"></div>
            <p className="ml-4 text-gray-600">Đang tải thông tin bất động sản...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      ...
      <div className="container mx-auto px-6 py-12">
          <div className="bg-red-100 text-red-700 p-6 rounded-lg shadow-md">
            ...
            <p>{error || 'Không thể tải thông tin bất động sản'}</p>
          </div>
          <Link href="/properties" className="mt-6 inline-block px-6 py-3 bg-blue-900 text-white rounded-md hover:bg-blue-800 transition-all duration-300">
            &larr; Quay lại danh sách bất động sản
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="relative w-full h-[500px]">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
          <div className="container mx-auto px-6 h-full flex flex-col justify-end pb-10">
            <div className=" p-6 rounded-lg inline-block max-w-2xl">
      ...
      <div className="container mx-auto px-6 -mt-10 relative z-10">
        <Link href="/properties" className="inline-block mb-6 text-white bg-blue-900 px-4 py-2 rounded-md hover:bg-blue-800 transition-all duration-300 shadow-lg">
          &larr; Quay lại danh sách bất động sản
        </Link>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
              <div className="p-8">
                ...
                <p className="text-gray-700 mb-8 leading-relaxed">
                  Bất động sản cao cấp này cung cấp tiện nghi tuyệt vời ở vị trí đắc địa. 
